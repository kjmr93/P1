...
<head>
    ...
    <title>Formulario de Inserción en Historial</title>
...
<body>
    <h2>Formulario de Inserción en Historial</h2>
    <form method="POST" action="insertar_conexion.php">
        <table id="insert-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="macssid" placeholder="MACSSID"></td>
                </tr>
            </tbody>
        </table>
