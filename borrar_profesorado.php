...
// Eliminar el usuario de la tabla "profesorado"
$sql = "DELETE FROM profesorado WHERE id = ?";
...
if ($stmt->execute()) {
    ...
    header("Location: profesorado.php?success=Usuario%20eliminado%20correctamente.");
    exit();
} else {
