...
// Actualizar los datos en la tabla "antenas"
$sql = "UPDATE antenas SET aula = ?, mac = ? WHERE id = ?";
...
$stmt->bind_param("ssi", $aula, $mac, $id);

if ($stmt->execute()) {
    // Redirigir con mensaje de éxito
    header("Location: antenas.php?success=Antena%20actualizada%20correctamente.");
    exit();
} else {
