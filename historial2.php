...
<head>
    ...
    <title>Borrar Historial de Conexiones</title>
...
<body>
    ...
    <div id="opciones" style="display: none; margin-top: 20px; margin-left: 20px">
        <form id="borrar-historial-form" method="POST" action="borrar_historial.php" style="margin-bottom: 20px;">
    ...
    <script>
        ...
        document.getElementById('borrar-historial-form').addEventListener('submit', function (event) {
            ...
            if (fechaInicio && fechaFin) {
                mensaje = `Se borrarán las conexiones entre las fechas especificadas (${fechaInicio} y ${fechaFin}), ¿desea continuar?`;
            } else {
                mensaje = 'AVISO: Se va a borrar el historial de conexiones completo, ¿desea continuar?';
            }
